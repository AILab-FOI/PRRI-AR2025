...
const riddles = [
  {
    description:
      "How many Newtons did the apple hit Isaac Newton with on the head according to this recreation?",
  ...
  {
    description:
      "The sum of all three make the beginnings of a great civilization.",
  ...
  {
    description:
      "Which color represents the wire that doesn't connect to the bomb?",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("submit-button").addEventListener("click", () => {
    ...
    if (
      (userAnswer === correctAnswer1 ||
        userAnswer === correctAnswer2 ||
        userAnswer === correctAnswer3) &&
      userAnswer !== "nevalidno"
    ) {
